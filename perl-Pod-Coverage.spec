...
%{?perl_default_filter}
%global __requires_exclude %{?__requires_exclude:__requires_exclude|}^%{?scl_prefix}perl\\(Devel::Symdump\\)$
%global __requires_exclude %{?__requires_exclude:%__requires_exclude|}^%{?scl_prefix}perl\\(Pod::Find\\)$
...
%changelog
* Wed Dec 04 2013 Jitka Plesnikova <jplesnik@redhat.com> - 0.23-4
- Update filters
- Resolves: rhbz#1038135

* Tue Nov 12 2013 Jitka Plesnikova <jplesnik@redhat.com> - 0.23-3
